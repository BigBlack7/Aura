...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttributes.Add(GameplayTags.Attributes_Secondary_CriticalHitChange, GetCriticalHitChangeAttribute);
...
{
	// Source是effect的causer，Target是effect的target（该AS的拥有者）
